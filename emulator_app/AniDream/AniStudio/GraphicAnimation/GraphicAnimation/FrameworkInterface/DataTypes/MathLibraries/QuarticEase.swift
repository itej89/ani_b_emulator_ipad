...
public class QuarticEase:EasingBase
{
    override public func easeIn(time_:Double) -> Double
    {
        ...
        return _change*ctime_*ctime_*ctime_*ctime_
    }
    ...
    override public  func easeOut(time_:Double) -> Double
    {
        ...
        return -_change * (ctime_*ctime_*ctime_*ctime_-1)
    }
    ...
    override public  func easeInOut(time_:Double) -> Double
    {
        ...
        if (ctime_<1)
        {
            return _change/2*ctime_*ctime_*ctime_*ctime_
        }
        
        ctime_ = ctime_ - 2
        return -_change/2*(ctime_*ctime_*ctime_*ctime_-2);
    }
}
